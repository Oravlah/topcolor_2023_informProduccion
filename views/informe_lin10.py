...
dcc.Location(id='url_rehacer'+linea, refresh=True),
                ...
                dbc.Col([dcc.Input(value='---', type='text', id='id_lin'+linea, disabled=True,
                                style={'margin-top': '5px', "width": "20%",
                                       'background-color': 'black', 'color': 'white',
                                       'text-align': 'center', 'font-size': '20px'})]),
             dbc.Col([html.H3('Informe Línea 8')]),
...
def revisar_informelinea(n_clicks, id_rep, linea):
    ...
    try:
        if n_clicks > 0:
            ...
            r40001 = df_graf.loc[:, 'canal1']
            r40003 = df_graf.loc[:, 'canal2']
            ...
            return (dbc.Card([
                    ...
                    dbc.CardBody([dbc.Row([dbc.Col([dcc.Input(value=f'Línea 8', type='text', id='nom_linea_det', disabled=True, style={"width": "100%", 'background-color': 'black','color':'white','text-align': 'center','font-size': '25px'})])]),
                        dbc.Row([dbc.Col([
                                dbc.Card([
                    ...
                    {'x': df_hora, 'y': r40001, 'type': 'line', 'name': 'Motor', 'line': {'color': 'yellow'}},
                    {'x': df_hora, 'y': r40003, 'type': 'line', 'name': ' extrusora', 'line': {'color': 'green'}},
