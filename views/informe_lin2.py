...
rango_ini = os.environ.get('RANGO_INI_placas')
rango_fin = os.environ.get('RANGO_FIN_placas')
...
def revisar_informelinea(n_clicks, id_rep, linea):
    ...
    try:
        if n_clicks > 0:
            ...
            linea_prueba='9'  ########################################   LINEA SOLO DE PRUEBA SE DEBE CAMBIAR POR EL PARAMETRO LINEA
                        ...
                        #################################################################################################
                                    ...
                                    dbc.CardBody([dbc.Row([dbc.Col([html.H6('OP:',style={'margin-top':'10px'})]),
                                          ...
                                          dbc.Row([dbc.Col([html.H6('PRODUCTO:', style={'margin-top': '10px'})]),
                                                   dbc.Col([dcc.Input(value=producto, type='text', id='producto_det', disabled=True,style={'margin-top': '4px', "width": "100%",'background-color': 'black', 'color': 'white', 'text-align': 'center', 'font-size': '10px'})])
                                                   ]),
                    ...
                    html.Div(
                        ...
                        dbc.Card([
                            dbc.CardBody([dcc.Graph(figure={'data': [
                                {'x': df_hora, 'y': ch1, 'type': 'line', 'name': 'motor extrusora ',
                                 'line': {'color': 'yellow'}},
                                {'x': df_hora, 'y': ch2, 'type': 'line', 'name': 'dosificador ',
                                 'line': {'color': 'green'}},
                                {'x': df_hora, 'y': prod, 'type': 'line', 'name': 'normalizada',
                                 'line': {'color': 'red'}},
