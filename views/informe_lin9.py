...
dcc.Location(id='url_rehacer'+linea, refresh=True),
                ...
                dbc.Col([dcc.Input(value='---', type='text', id='id_lin'+linea, disabled=True,
                                style={'margin-top': '5px', "width": "20%",
                                       'background-color': 'black', 'color': 'white',
                                       'text-align': 'center', 'font-size': '20px'})]),
             dbc.Col([html.H3('Informe Línea Blanco')]),
    ...
    try:
        if n_clicks > 0:
            ...
            return (dbc.Card([
                    ...
                    dbc.CardBody([dbc.Row([dbc.Col([dcc.Input(value=f'Línea Blanco', type='text', id='nom_linea_det', disabled=True, style={"width": "100%", 'background-color': 'black','color':'white','text-align': 'center','font-size': '25px'})])]),
                        dbc.Row([dbc.Col([
                                dbc.Card([
                ...
                {'x': df_hora, 'y': ch2, 'type': 'line', 'name': 'gala', 'line': {'color': 'red'}},
                                {'x': df_hora, 'y': prod, 'type': 'line', 'name': 'produccion',
                                 'line': {'color': 'blue'}},
